...
export default function Hero() {
    ...
    const goToCatalog = () => {
        const anchor = document.getElementById("catalogo-anchor") || document.getElementById("catalogo");
        if (anchor) {
    ...
    return (
      <section className="bg-[#c2185b]/10 dark:bg-gradient-to-br from-[#120d1f] via-[#0e0b18] to-[#0c0a14] text-zinc-900 dark:text-white transition-colors duration-500">
