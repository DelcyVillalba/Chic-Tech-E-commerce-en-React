...
export default function Hero() {
  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] md:min-h-[calc(100vh-5rem)] flex items-center bg-[#fbe8efbd] dark:bg-[#05040a] text-zinc-900 dark:text-white transition-colors duration-500">
