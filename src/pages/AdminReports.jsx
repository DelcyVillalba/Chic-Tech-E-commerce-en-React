        ...
        topProducts && topProducts.length
          ? topProducts
              .map(
                (p, i) =>
                  `<tr>
                                    <td style="padding:4px 8px;border:1px solid #e5e5e5;">${
                                      i + 1
                                    }</td>
                                    <td style="padding:4px 8px;border:1px solid #e5e5e5;">${
                                      p.name
                                    ...
                                    <td style="padding:4px 8px;border:1px solid #e5e5e5;text-align:right;">${
                                      p.sales ?? 0
                                    }</td>
                                </tr>`
              )
...
<html lang="es">
  ...
  <body>
    ...
    <button onclick="window.print()" style="margin-top:16px;padding:6px 10px;border-radius:9999px;border:1px solid #e5e5e5;background:#111827;color:#ffffff;font-size:11px;cursor:pointer;">
      ...
      alert(
        "No se pudo generar el PDF. Probá de nuevo o exportá desde el navegador."
      );
    }
  };
  ...
  const getPresetButtonClasses = (preset) => {
    ...
    return `${base} text-gray-700 dark:text-gray-200 bg-[#e5e7eb] dark:bg-[#0f0b14] hover:bg-gray-50 dark:hover:bg-white/10`;
  };
  ...
  return (
    <AdminShell title="Reportes">
      <div className="space-y-6 w-full text-zinc-900 dark:text-zinc-100 transition-colors">
        {/* Filtros */}
        <div className="bg-[#e5e7eb] dark:bg-[#131121] rounded-2xl p-4 shadow-sm border border-zinc-300 dark:border-[#2a2338]">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="relative flex-1 min-w-[140px]">
              <input
                ...
                className="w-full rounded-md border border-zinc-200 dark:border-[#2a2338] bg-[#e5e7eb] dark:bg-[#131121] shadow-sm focus:border-[#f1197d] focus:ring-[#f1197d] text-sm text-gray-900 dark:text-gray-100"
              />
            </div>
            <span className="self-center text-gray-400 dark:text-gray-400">
              -
            </span>
            <div className="relative flex-1 min-w-[140px]">
              <input
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {summaryCards.map((card, index) => (
            <div
              key={index}
              className="bg-[#e5e7eb] dark:bg-[#131121] rounded-2xl p-6 border border-zinc-300 dark:border-[#2a2338] shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-[#e5e7eb] dark:bg-[#131121] border border-zinc-300 dark:border-[#2a2338] p-6 rounded-2xl shadow-sm">
            ...
            <div className="h-80 bg-[#f9fafb] dark:bg-white/95 rounded-xl p-4 flex items-center justify-center">
              {hasSalesData ? (
                      ...
                      datasets: [
                        {
                          ...
                          backgroundColor: reportData.salesData.labels.map(
                            (_, i) => {
                              const palette = [
                                "#cc1170",
                                "#0EA5E9FF",
                    ...
                    <div
                      ...
                      style={{
                        width: `${
                          (product.sales /
                            Math.max(
                              ...reportData.topProducts.map((p) => p.sales)
                            )) *
                          100
                        }%`,
                      }}
        ...
        <div className="bg-[#e5e7eb] dark:bg-[#131121] rounded-2xl overflow-hidden border border-zinc-300 dark:border-[#2a2338] shadow-sm">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-[#2a2338]">
              ...
              <tbody className="bg-[#e5e7eb] dark:bg-[#0f0b14] divide-y divide-gray-200 dark:divide-[#2a2338]">
                          ...
                          <div className="flex items-center">
                            {img ? (
                              <img
                                src={img}
                                alt={displayName}
                                className="flex-shrink-0 h-10 w-10 rounded-md object-cover border border-zinc-200 dark:border-[#2a2338] bg-gray-100 dark:bg-[#131121]"
                              />
                            ) : (
          ...
          <div className="bg-gray-50 dark:bg-[#161225] px-6 py-3 flex items-center justify-between border-t border-gray-200 dark:border-[#2a2338]">
            ...
            <div className="flex space-x-2">
              <button
                className="px-3 py-1 border border-zinc-300 dark:border-[#2a2338] rounded-md text-sm font-medium text-gray-700 dark:text-gray-200 bg-[#e5e7eb] dark:bg-[#0f0b14] hover:bg-gray-50 dark:hover:bg-white/10"
                disabled
              >
                Anterior
              </button>
