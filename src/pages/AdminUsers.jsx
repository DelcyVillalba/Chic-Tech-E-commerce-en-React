  ...
  return (
    <AdminShell title="Usuarios" onRefresh={load}>
      <div className="space-y-3 w-full text-zinc-900 dark:text-zinc-100 transition-colors">
        ...
        <form
          onSubmit={submit}
          className="grid md:grid-cols-5 gap-2 border border-zinc-200 dark:border-[#2a2338] rounded-2xl p-3 bg-white dark:bg-[#0f0b14]"
        >
          {err && (
          ...
          <input
            className="border border-zinc-200 dark:border-[#2a2338] bg-white dark:bg-[#0f0b14] rounded px-3 py-2 md:col-span-1 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400"
            placeholder="Nombre"
            value={form.name}
            onChange={(e) => setForm({ ...form, name: e.target.value })}
          />
          <input
            className="border border-zinc-200 dark:border-[#2a2338] bg-white dark:bg-[#0f0b14] rounded px-3 py-2 md:col-span-2 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400"
            placeholder="Email"
            value={form.email}
          ...
          />
          <select
            className="border border-zinc-200 dark:border-[#2a2338] bg-white dark:bg-[#0f0b14] rounded px-3 py-2 md:col-span-1 text-gray-900 dark:text-gray-100"
            value={form.role}
        ...
        <table className="w-full text-sm border border-zinc-200 dark:border-[#2a2338] bg-white dark:bg-[#0f0b14] rounded-2xl overflow-hidden">
          ...
          <tbody>
            {rows.map((u) => (
              <tr key={u.id} className="border-t border-zinc-200 dark:border-[#2a2338]">
                ...
                <td className="p-2">
                  <select
                    className="border border-zinc-200 dark:border-[#2a2338] rounded px-2 py-1 bg-white dark:bg-[#0f0b14] text-gray-900 dark:text-gray-100"
                    value={u.role}
                    onChange={async (e) => {
